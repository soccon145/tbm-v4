...
export const THE_CONTENT: Record<TheKey, TheInfo> = {
  ...
  damthap: {
    ...
    yeuTo: ["Dễ tăng cân, đặc biệt vùng bụng","Cảm giác cơ thể nặng nề, uể oải","Da dầu, dễ nổi mụn ẩn"],
  ...
  huyetu: {
    ...
    yeuTo: ["Da sạm, không đều màu, thiếu sức sống","Dễ xuất hiện vết thâm, lâu mờ","Đau cố định một chỗ (đau nhức rõ vị trí)"],
